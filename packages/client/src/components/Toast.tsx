...
/** Module-level bridge so non-React code can fire toasts. */
let activeDispatch: ToastContextValue | null = null;

/** Convenience helper accepting either ToastInit or showToast(message, variant). */
...
/** Default export retained for import sites that mount the provider separately. */
export default function ToastContainer() {
  // The real viewport is mounted by ToastProvider; this default export stays
  // around only for import stability.
  return null;
}
